...
_C.TRAIN.DATA.FILTERING.SEGMENT_LIST = ['']
_C.TRAIN.DATA.FILTERING.TASK = ''
_C.TRAIN.DATA.FS = 0
...
_C.TRAIN.DATA.PREPROCESS.CROP_FACE.FACE_ALIGNMENT = False
_C.TRAIN.DATA.PREPROCESS.CROP_FACE.FIXED_MATRIX_PATH = ""
...
_C.VALID.DATA.FILTERING.SEGMENT_LIST = ['']
_C.VALID.DATA.FILTERING.TASK = ''
_C.VALID.DATA.FS = 0
...
_C.VALID.DATA.PREPROCESS.CROP_FACE.FACE_ALIGNMENT = False
_C.VALID.DATA.PREPROCESS.CROP_FACE.FIXED_MATRIX_PATH = ""
...
# -----------------------------------------------------------------------------\
_C.TEST = CN()
_C.TEST.OUTPUT_SAVE_DIR = ''    # derived from LOG.PATH in update_config if left empty
_C.TEST.EXCEL_SAVE_DIR = ''     # derived from LOG.PATH in update_config if left empty
_C.TEST.METRICS = []
...
_C.TEST.DATA.FILTERING.SEGMENT_LIST = ['']
_C.TEST.DATA.FILTERING.TASK = ''
_C.TEST.DATA.FS = 0
...
_C.TEST.DATA.PREPROCESS.CROP_FACE.FACE_ALIGNMENT = False
_C.TEST.DATA.PREPROCESS.CROP_FACE.FIXED_MATRIX_PATH = ""
...
_C.UNSUPERVISED.DATA.FILTERING.SEGMENT_LIST = ['']
_C.UNSUPERVISED.DATA.FILTERING.TASK = ''
...
_C.UNSUPERVISED.DATA.MODALITY = 'RGB'
...
_C.UNSUPERVISED.DATA.PREPROCESS.CROP_FACE.FACE_ALIGNMENT = False
...
_C.MODEL.LOSS_TIME_WEIGHT = 0.6

# -----------------------------------------------------------------------------
# MSMamba parameters
# -----------------------------------------------------------------------------
_C.MODEL.MSMamba = CN()
_C.MODEL.MSMamba.FRAMES = 160
_C.MODEL.MSMamba.DEPTH = 4
_C.MODEL.MSMamba.EMBED_DIM = 96
...
def update_config(config, args):
    ...
    if config.TOOLBOX_MODE == 'train_and_test' or config.TOOLBOX_MODE == 'only_test':
        ...
        if not config.TEST.EXCEL_SAVE_DIR:
            config.TEST.EXCEL_SAVE_DIR = os.path.join(config.LOG.PATH, config.TEST.DATA.EXP_DATA_NAME, 'metrics_results')
    ...
    # Append the training modality to MODEL_FILE_NAME for MSMamba checkpoints
    if config.MODEL.NAME == 'MSMamba' and config.TOOLBOX_MODE == 'train_and_test':
        mod_tag = {'MULTI_SPECTRAL': 'multi', 'RGB': 'rgb', 'NIR': 'nir'}.get(
            config.TRAIN.DATA.MODALITY, config.TRAIN.DATA.MODALITY.lower())
        config.TRAIN.MODEL_FILE_NAME = f'{config.TRAIN.MODEL_FILE_NAME}_{mod_tag}'
